...
JOS_LOADER_DEPS := LoaderPkg/Loader/*.c LoaderPkg/Loader/hash.c LoaderPkg/Loader/*.h LoaderPkg/Loader/*.inf LoaderPkg/*.dsc LoaderPkg/*.dec 
...
IMAGES = $(OVMF_FIRMWARE) $(OBJDIR)/kern/kernel
IMAGES += $(JOS_ESP)/EFI/BOOT/kernel  $(JOS_LOADER) $(JOS_ESP)/EFI/BOOT/$(JOS_BOOTER)
